...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=2,
        help=(
            "pack this many K128 checkpoint/activation scales into each "
            "native UMMA scale record"
        ),
    )
    parser.add_argument(
        ...
        choices=(1, 2),
        default=2,
        help="group consecutive M128 native projection tasks per UMMA epilogue",
    )
    parser.add_argument(
        "--kv-cache-fusion",
        choices=("off", "project"),
