...
from operator_cases import (
    ...
    benchmark_case,
    build_silu_case,
    build_silu_codegen_case,
    launch_and_sync,
)


class TestSiluOperator:
    @pytest.mark.no_gpu
    def test_codegen_without_gpu(self, dae_runtime):
        codegen = build_silu_codegen_case()
    ...
    def test_correctness_gpu(self, cuda_device):
        case = build_silu_case(cuda_device)
    ...
    def test_performance_smoke_gpu(self, cuda_device):
        stats = benchmark_case(build_silu_case(cuda_device))
