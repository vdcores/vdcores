    ...
    while (!finish) {
      ...
      switch (inst.opcode) {
        ...
        case OP_ATTENTION_M64N64K16_F16_F32_64_64_hdim: {
          ...
          task_attention_fwd_flash3_grouped<128, 64, 64, kernel_QK, kernel_PV>(inst.args[0], inst.args[1], need_norm, need_rope, smem_base, (float*)scratch_space, st_insts, m2c, c2m);
        }
          break;
        case OP_ATTENTION_M64N64K16_F16_F32_64_64_hdim64: {
          ...
          bool need_norm = inst.args[2] & 0x1;
          bool need_rope = (inst.args[2] >> 1) & 0x1;
          task_attention_fwd_flash3_grouped<64, 64, 64, kernel_QK, kernel_PV>(inst.args[0], inst.args[1], need_norm, need_rope, smem_base, (float*)scratch_space, st_insts, m2c, c2m);
        }
          break;
