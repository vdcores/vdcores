...
The checked-in source defines many compute handlers, but the currently generated build selection in [build/generated/dae/selected_compute_ops.inc](/home1/11362/depctg/vdcores/build/generated/dae/selected_compute_ops.inc) only includes:

- `OP_COPY`
- `OP_TERMINATEC`

So the VM model above is the source-level model, not the exact minimal operator subset currently compiled into the local extension artifact.
